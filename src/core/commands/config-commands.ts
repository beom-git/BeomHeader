...
// Description   : 
//
//     This file contains configuration commands for the extension.
//        o Author and project configuration
//        o Header style and format settings
//        o License and copyright configuration
//
//----------------------------------------------------------------------
